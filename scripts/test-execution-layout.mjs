...
} from "../skills/workflows/stnl-slice-quality-manager/runtime/validate-execution-layout.mjs";
...
test("CLI is compact, read-only, and invokes no test or runner process", async (t) => {
  ...
  const entry = path.resolve(
    "skills/workflows/stnl-slice-quality-manager/runtime/validate-execution-layout.mjs",
  );
