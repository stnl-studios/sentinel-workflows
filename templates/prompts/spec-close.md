...
Retorne `SPEC_CLOSED`. Este fechamento consolida autoridade documental, é independente da conclusão da execução e não declara aprovação durável de delivery.
