...
Allow an invited user to accept one valid invitation exactly once while expired invitations remain rejected, and complete the explicit delivery-telemetry verification milestone for that flow.
