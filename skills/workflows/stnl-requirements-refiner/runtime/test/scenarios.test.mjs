...
function multiDomainCandidate() {
  ...
  return {
    contract_version: 1, refinement_id: "REF-SPRINT-MULTI-DOMAIN", title: "Multi-domain sprint refinement", summary: "Cross four independently deliverable capabilities and their repository relationships.",
    ...
    relationships: [
      { id: "REL-001", type: "DEPENDENCY", title: "Checkout depends on Cart", state: "ACTIVE", need_ids: ["NEED-001", "NEED-003"], evidence_ids: ["EVD-005"], detail: "Checkout consumes the persisted Cart state.", from_need_id: "NEED-003", to_need_id: "NEED-001" },
      { id: "REL-002", type: "SHARED_TECHNICAL_SURFACE", title: "Coupon and Checkout share Pricing", state: "ACTIVE", need_ids: ["NEED-002", "NEED-003"], evidence_ids: ["EVD-005"], detail: "Both capabilities use the same Pricing authority." },
